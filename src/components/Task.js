...
export default props => {
    ...
    return (
        <Swipeable leftActionActivationDistance={200}
            //Pra esquerda já dispara o evento. Pra direita aparecem os botões
...
const styles = StyleSheet.create({
    ...
    exclude: {
        ...
        backgroundColor: 'red',
        flexDirection: 'row',
        justifyContent: 'flex-end', //Justify -> direção do flex
        alignItems: 'center', //Align -> transversal ao justify
    },
    excludeText: {
        fontFamily: commonStyles.fontFamily,
        color: '#FFF',
